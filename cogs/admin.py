...
class Admin(commands.Cog):
    ...
    @commands.has_any_role('Shadow Guru', 'Community Manager', 'Head of Community', 'Shadow Support Lead',
                           'Shadow Customer Support', 'Moderators', 'Admin')
    async def load(self, ctx, *, module):
        """Loads a module."""
        if not await self.can_run_command(ctx.author.roles, ['Shadow Guru', 'Community Manager', 'Head of Community',
                                                             'Shadow Support Lead', 'Shadow Customer Support',
                                                             'Moderators']):
    ...
    @commands.command(hidden=True)
    @commands.has_any_role('Shadow Guru', 'Community Manager', 'Head of Community', 'Shadow Support Lead',
                           'Shadow Customer Support', 'Moderators', 'Admin', 'Shadow Staff', 'Code Approvers')
    ...
    @commands.command(hidden=True)
    @commands.has_any_role('Shadow Guru', 'Community Manager', 'Head of Community', 'Shadow Support Lead',
                           'Shadow Customer Support', 'Moderators', 'Admin', 'Code Approvers')
    ...
    async def _reload(self, ctx, *, module):
        ...
        if not await self.can_run_command(ctx.author.roles, ['Shadow Guru', 'Community Manager', 'Head of Community',
                                                             'Shadow Support Lead', 'Shadow Customer Support',
                                                             'Moderators','Shadow Staff', 'Code Approvers']):
            await ctx.send("{author} You aren't authorized to do that.".format(author=ctx.author.mention))
            return
        try:
            self.bot.unload_extension(module)
    ...
    async def can_run_command(role_check, allowed=None):
        ...
        if allowed is None:
            allowed = ['Shadow Guru', 'Community Manager', 'Adélina', 'Shadow Support Lead', 'Shadow Customer Support',
                       'Moderators', 'Shadow Staff', 'Code Approvers', 'Admin', 'Silent Admin', 'Administrator',
                       'Bot User', 'International Discord Team']
        for item in allowed:
    ...
    @commands.has_any_role('Shadow Guru', 'Community Manager', 'Head of Community', 'Shadow Support Lead',
                           'Shadow Customer Support', 'Moderators', 'Admin', 'Shadow Staff', 'Bot User')
...
2. Traceroute from your local IP to Shadow
    ...
    async def _timertest(self, ctx):
        ...
        if await self.can_run_command(ctx.author.roles, ['Shadow Guru', 'Community Manager', 'Head of Community',
                                                         'Shadow Support Lead', 'Shadow Customer Support', 'Moderator']):
            timers = " "
    ...
    async def add_role(self, ctx, user: discord.Member, *,  roles: commands.Greedy[discord.Role] = None):
        ...
        if roles is None:
            ...
            roles.append(oroles)
        if await self.can_run_command(ctx.author.roles, ['Shadow Guru', 'Community Manager', 'Head of Community',
                                                         'Shadow Support Lead', 'Shadow Customer Support', 'Moderators',
                                                         'Admin', 'Shadow Staff']):
            for role in roles:
                if user is None:
    ...
    @commands.has_any_role('Shadow Guru', 'Community Manager', 'Head of Community', 'Shadow Support Lead',
                           'Shadow Customer Support', 'Moderators', 'Shadow Staff')
    async def logs(self, ctx):
        """Logs Command"""
        if await self.bot.admin.can_run_command(ctx.author.roles, ['Shadow Guru', 'Community Manager',
                                                                   'Head of Community', 'Shadow Support Lead',
                                                                   'Shadow Customer Support', 'Moderators',
                                                                   'Shadow Staff']):
            fname = 'discord.log'
    ...
    @commands.has_any_role('Shadow Staff', 'Shadow Guru', 'Community Manager', 'Head of Community',
                           'Shadow Support Lead', 'Shadow Customer Support', 'Moderators')
    ...
    @commands.has_any_role('Admin', 'Shadow Staff', 'Shadow Guru', 'Community Manager', 'Head of Community',
                           'Shadow Support Lead', 'Shadow Customer Support', 'Moderators')
